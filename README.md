...
- Peptide QC（https://github.com/PeptidoMexico/peptidomexico-open-science/tree/main/packages/peptide-qc）：Research-use-only sequence quality-control calculations for peptide composition, elemental formula, mass, approximate charge, pI and hydropathy.
